...
const Tasks = () => {
  ...
  const { task } = useSelector((state) => state.taskSlices);
        ...
        <div className="grid grid-cols-3 gap-5 mt-10">
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                pendingTask?.map(item => <TaskCard key={item.id} data={item} ></TaskCard>)
              }
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                inProgressTask?.map(item => <TaskCard key={item.id} data={item} ></TaskCard>)
              }
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                completeTask?.map(item => <TaskCard key={item.id} data={item} ></TaskCard>)
              }
            </div>
          </div>
        </div>
